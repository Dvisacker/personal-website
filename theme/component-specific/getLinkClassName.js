    ...
    switch (color) {
        case "neutral":
            return Themer.createLinkAppearance({
                ...
                focus: {
                    boxShadow: `0 0 0 2px ${tinycolor(palette.neutral.base).setAlpha(0.4).toString()}`,
                },
            });
        case "green":
            return Themer.createLinkAppearance({
                ...
                focus: {
                    boxShadow: `0 0 0 2px ${tinycolor(palette.green.base).setAlpha(0.4).toString()}`,
                },
            });
        case "default":
        case "blue":
        default:
            return Themer.createLinkAppearance({
                ...
                focus: {
                    // boxShadow: `0 0 0 2px ${tinycolor(palette.blue.base).setAlpha(0.4).toString()}`,
                },
            });
    }
};
